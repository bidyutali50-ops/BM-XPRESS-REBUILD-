...
export default function Hero() {
  ...
  return (
    <section id="top" ref={root} className="mx-auto max-w-6xl px-5 pb-28 pt-16 sm:px-8 sm:pt-24">
      ...
      <p className="hero-fade mt-14 max-w-2xl text-lg leading-relaxed text-ink/75 sm:text-xl">
        BM Xpress runs hyperlocal and last-mile delivery across West Bengal on our own
        dispatch platform and our own rider network. Nothing is subcontracted into a black
        box, so you can see where a shipment is at any point in its life.
      </p>
